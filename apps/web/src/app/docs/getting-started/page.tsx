...
# Replace cli-v0.2.0 with the latest CLI release tag
curl -fsSL https://github.com/portzero-dev/portzero/releases/download/cli-v0.2.0/portzero-darwin-aarch64.tar.gz | tar xz
